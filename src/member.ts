...
export interface Member {
   ...
   *
   * @param shift - The callback that returns the transformer function to apply
   ...
   * cached value.
   *
   * @param cached - The callback that returns the pre-calculated safe value or
   *   fallback to return instead of the real one.
   * @param receiver - The `this` context for evaluating the property or method.
   *
